...
const approvalItems = [
  {
    id: 1,
    title: "3 things that actually moved the needle as a founder",
    platform: "LinkedIn",
    status: "Needs Review" as const,
  },
  {
  ...
  {
    id: 3,
    title: "Behind the scenes: building Trust Tai week 1",
    platform: "Instagram",
    status: "Needs Review" as const,
  },
  {
    id: 4,
    title: "Roadmap offer post — direct CTA edition",
    platform: "LinkedIn",
    status: "Needs Review" as const,
  },
];
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-8 space-y-6">
              ...
              <div className="flex gap-3 overflow-x-auto pb-2">
                {weekPosts.map((post) => (
                  ...
                  >
                    {/* Image placeholder */}
                    <div
                      className={`h-24 bg-gradient-to-br ${post.gradient}`}
                    />
                    {/* Card body */}
                    <div className="p-3">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
              ...
              <div className="space-y-3">
                {recommendations.map((rec) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full font-medium ${colorIconMap[rec.color]}`}
                    >
                      Act
                    </span>
                  </div>
              ...
              <button className="mt-4 w-full py-2.5 rounded-lg bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 transition-colors flex items-center justify-center gap-2">
          ...
          <div className="col-span-4 space-y-5">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5">
                        <span
                          className={`text-[10px] text-white px-1.5 py-0.5 rounded font-medium ${platformColors[item.platform] ?? "bg-gray-400"}`}
                        >
                          {item.platform === "LinkedIn" ? "LI" : "IG"}
                        </span>
              ...
              <button className="mt-3 w-full py-2 rounded-lg border border-gray-200 text-sm font-medium text-[#64748B] hover:bg-gray-50 transition-colors">
                Review All
              </button>
            </div>
